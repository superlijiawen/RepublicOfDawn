package data.missions.RD_Mission2;
...
//		api.getDefaultCommander(FleetSide.PLAYER).getStats().setSkillLevel(Skills.ELECTRONIC_WARFARE, 3);
        ...
        //风筝*3  伯劳鸟*2 猎鹰*1  监视者*2
        api.addToFleet(FleetSide.ENEMY, "falcon_Attack", FleetMemberType.SHIP, "Jack", true);
        api.addToFleet(FleetSide.ENEMY, "kite_Starting", FleetMemberType.SHIP, "enemy2", false);
        api.addToFleet(FleetSide.ENEMY, "kite_Starting", FleetMemberType.SHIP, "enemy3", false);
        api.addToFleet(FleetSide.ENEMY, "kite_Starting", FleetMemberType.SHIP, "enemy4", false);
        api.addToFleet(FleetSide.ENEMY, "shrike_Attack", FleetMemberType.SHIP, "enemy5", false);
        api.addToFleet(FleetSide.ENEMY, "shrike_Attack", FleetMemberType.SHIP, "enemy6", false);
        api.addToFleet(FleetSide.ENEMY, "monitor_Escort", FleetMemberType.SHIP, "enemy7", false);
